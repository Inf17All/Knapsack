...
class StatisticsHelper {
    ...
    static double calculateQuantile(List<Double> evaluations, double quantile) {
        if (quantile < 0 || quantile > 1)
            throw new IllegalArgumentException(Configuration.instance.wrongStatisticMode + quantile +
    ...
    static List<Double> calculateIqr(List<Double> evaluations, double iqr) {
        if (iqr < 0 || iqr > 1)
            throw new IllegalArgumentException(Configuration.instance.wrongStatisticMode + iqr +
